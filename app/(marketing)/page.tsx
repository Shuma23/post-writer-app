    ...
    <>
      ...
      >
        <div className="text-center space-y-6 max-w-[58rem] mx-auto">
          ...
          <p className="text-muted-foreground sm:text-lg md:leading-7">
            このプロジェクトはモダンな技術スタックを使って作られたWEBアプリケーションです。Next.js
            AppRouterやcontentlayerを利用してマークダウン形式でブログ投稿ができます。
          </p>
        </div>

        <div className="grid mx-auto sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-[64rem]">
          ...
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 h-[180px]">
              ...
              >
                <path
                  fill="currentColor"
                  d="M11.8 5.7A4.8 4.8 0 0 0 7 10a3.4 3.4 0 0 1 2.7-1.7c1.7 0 3 2 3.8 2.6a5.7 5.7 0 0 0 5.4 1c2-.7 2.9-3 3.1-4c-1 1.4-2.4 2.2-4.3 1.2c-1.2-.6-2.1-3.4-6-3.3Zm-5 6.3A4.8 4.8 0 0 0 2 16.2a3.4 3.4 0 0 1 2.7-1.7c1.7 0 3 2 3.8 2.6a5.7 5.7 0 0 0 5.4.9c2-.7 3-2.9 3.1-4c-1 1.4-2.4 2.3-4.2 1.3c-1.3-.7-2.2-3.4-6-3.3"
                />
              </svg>
              <div className="space-y-2">
      ...
      <section id="contact" className="container py-8 md:py-12 lg:py-24">
        <div className="max-w-[58rem] mx-auto text-center flex flex-col gap-4">
          <h2 className="text-3xl md:text-6xl font-extrabold">Contact Me</h2>
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
